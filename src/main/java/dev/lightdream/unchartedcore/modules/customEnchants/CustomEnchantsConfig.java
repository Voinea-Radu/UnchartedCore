...
public class CustomEnchantsConfig {
    ...
    public CustomEnchant swanSong = new CustomEnchant(1004, "Swan Song", 1, Arrays.asList("ARMOR", "BOOK"), 100, Arrays.asList("5")); //time
    public CustomEnchant unstable = new CustomEnchant(1005, "Unstable", 3, Arrays.asList("WEAPON", "BOOK"), 100, Arrays.asList("0.5")); //damage
    public CustomEnchant sinker = new CustomEnchant(1005, "Sinker", 1, Arrays.asList("WEAPON", "BOOK"), 100, Arrays.asList("-1")); //y velocity
