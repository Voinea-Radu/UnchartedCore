...
public class AntiDepthStrider extends Enchantment {
    public AntiDepthStrider(int id) {
        super(id);
    }

    @Override
    public String getName() {
        return CustomEnchantsModule.instance.settings.antiDepthStrider.name;
    }

    @Override
    public int getMaxLevel() {
        return CustomEnchantsModule.instance.settings.antiDepthStrider.maxLevel;
    }
    ...
    public boolean canEnchantItem(ItemStack item) {
        for (String target : CustomEnchantsModule.instance.settings.antiDepthStrider.target) {
